...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { age: @planet.age, name: @planet.name, type: @planet.type } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { age: @planet.age, name: @planet.name, type: @planet.type } }
